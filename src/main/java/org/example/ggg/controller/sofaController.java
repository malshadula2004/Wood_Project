...
public class sofaController {
    ...
    @FXML
    private Button addSofaBtn;

    private HBox currentRow;
    private int imageCount = 0;

    private final String SAVE_FILE = "sofa_image_paths.txt"; // File to save sofa image paths
    ...
    @FXML
    public void addSofaAction(ActionEvent actionEvent) {
        FileChooser fileChooser = new FileChooser();
        fileChooser.getExtensionFilters().add(new FileChooser.ExtensionFilter("Image Files", "*.png", "*.jpg", "*.jpeg"));

        Stage stage = (Stage) addSofaBtn.getScene().getWindow();
